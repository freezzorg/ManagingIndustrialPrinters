    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: Icon(isHardwareScannerMode ? Icons.qr_code_scanner : Icons.camera_alt),
      ...
      body: Stack(
        children: [
          Column(
            children: [
              if (!isHardwareScannerMode) // Верхняя часть только для режима камеры
                Expanded(
                  flex: 3,
                  child: Container(
              ...
              Expanded(
                flex: isHardwareScannerMode ? 1 : 2, // Полный экран для ТСД
                child: Padding(
